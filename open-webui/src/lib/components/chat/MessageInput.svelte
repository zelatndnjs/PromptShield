<script lang="ts">
	...
	import ShieldToggle from '../shield_toggle.svelte';
	...
	function toggleMutation() {
  		promptMutationEnabled = !promptMutationEnabled;
  			fetch('/update_mutation', {
    		method: 'POST',
    		headers: { 'Content-Type': 'application/json' },
    		body: JSON.stringify({ enabled: promptMutationEnabled }),
 	 	});
	}

	function toggleFiltering() {
  		promptFilteringEnabled = !promptFilteringEnabled;
  			fetch('/update_filtering', {
    		method: 'POST',
    		headers: { 'Content-Type': 'application/json' },
								...
								<div class=" flex justify-between mt-1.5 mb-2.5 mx-0.5 max-w-full">
									<div class="ml-1 self-end gap-0.5 flex items-center flex-1 max-w-[80%]">
										<InputMenu
											...
											isShieldEnabled={promptShieldEnabled}
											isMutationEnabled={promptMutationEnabled}
											isFilteringEnabled={promptFilteringEnabled}
