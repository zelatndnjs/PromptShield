<script lang="ts">
	...
	import Shield_Toggle from '$lib/components/shield_toggle.svelte'; // 상대 경로 맞게 수정
	...
	export let isShieldEnabled: boolean;
	export let isMutationEnabled: boolean;
	export let isFilteringEnabled: boolean;

	export let toggleShield: () => void;
	export let toggleMutation: () => void;
	export let toggleFiltering: () => void;
