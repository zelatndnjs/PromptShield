<script lang="ts">
	...
	const toggleShield = () => (isShieldEnabled = !isShieldEnabled);
	const toggleMutation = () => (isMutationEnabled = !isMutationEnabled);
	const toggleFiltering = () => (isFilteringEnabled = !isFilteringEnabled);
